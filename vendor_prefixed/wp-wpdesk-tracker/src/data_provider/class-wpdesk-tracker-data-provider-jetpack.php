...
if (!\class_exists('ShopMagicCartVendor\\WPDesk_Tracker_Data_Provider_Jetpack')) {
    ...
    class WPDesk_Tracker_Data_Provider_Jetpack implements \WPDesk_Tracker_Data_Provider
    {
        ...
        public function get_data()
        {
            ...
            $data['jetpack_connected'] = \class_exists('ShopMagicCartVendor\\Jetpack') && \is_callable('Jetpack::is_active') && \ShopMagicCartVendor\Jetpack::is_active() ? 'yes' : 'no';
            $data['jetpack_is_staging'] = \class_exists('ShopMagicCartVendor\\Jetpack') && \is_callable('Jetpack::is_staging_site') && \ShopMagicCartVendor\Jetpack::is_staging_site() ? 'yes' : 'no';
