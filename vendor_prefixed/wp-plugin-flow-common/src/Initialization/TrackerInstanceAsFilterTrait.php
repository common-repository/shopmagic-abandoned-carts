...
trait TrackerInstanceAsFilterTrait
{
    ...
    private function register_tracker_ui_extensions()
    {
        ...
        $tracker_ui = new \ShopMagicCartVendor\WPDesk\Tracker\OptInOptOut($this->plugin_info->get_plugin_file_name(), $this->plugin_info->get_plugin_slug(), $shop_url, $this->plugin_info->get_plugin_name());
