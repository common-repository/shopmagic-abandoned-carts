...
trait HookableParent
{
     ...
     */
    public function add_hookable(\ShopMagicCartVendor\WPDesk\PluginBuilder\Plugin\Hookable $hookable_object)
    {
        if ($hookable_object instanceof \ShopMagicCartVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant) {
    ...
    protected function hooks_on_hookable_objects()
    {
        ...
        foreach ($this->hookable_objects as $hookable_object) {
            if ($hookable_object instanceof \ShopMagicCartVendor\WPDesk\PluginBuilder\Plugin\Conditional) {
