 ...
 */
class WPDesk_Plugin_Info implements \ShopMagicCartVendor\WPDesk_Translatable, \ShopMagicCartVendor\WPDesk_Buildable, \ShopMagicCartVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
