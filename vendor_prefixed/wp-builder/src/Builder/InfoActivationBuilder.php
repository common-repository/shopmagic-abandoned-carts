 ...
 */
class InfoActivationBuilder extends \ShopMagicCartVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \ShopMagicCartVendor\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
            $this->plugin->set_active();
        }
        return $this->plugin;
    }
    public function store_plugin(\ShopMagicCartVendor\WPDesk\PluginBuilder\Storage\PluginStorage $storage)
    {
